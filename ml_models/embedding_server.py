...
DB_URL = os.environ.get(
    "DATABASE_URL", "postgresql://postgres:123@postgres:5432/intellifit_db")
MODEL_NAME = os.environ.get(
    "EMBEDDING_MODEL", "sentence-transformers/all-MiniLM-L6-v2")
# Limit parallelism to reduce CPU and memory usage on constrained machines
os.environ.setdefault("OMP_NUM_THREADS", os.environ.get(
    "EMBEDDER_OMP_THREADS", "1"))
os.environ.setdefault("OPENBLAS_NUM_THREADS", os.environ.get(
    "EMBEDDER_OPENBLAS_THREADS", "1"))
os.environ.setdefault("MKL_NUM_THREADS", os.environ.get(
    "EMBEDDER_MKL_THREADS", "1"))
