...
('Standard Monthly', 'Equipment booking plus AI-powered workout and coaching features', 79.99, 30, 50, '["Equipment Booking", "AI Coach", "AI Workout Generator", "AI Nutrition Plan"]', 5, true, true, '2024-01-01', '2024-01-01'),
('Premium Monthly', 'Full access: equipment booking, AI features, personal coach booking and plan reviews', 129.99, 30, 100, '["Equipment Booking", "AI Coach", "AI Workout Generator", "Coach Booking", "Coach Plan Review", "AI Nutrition Plan"]', 10, true, true, '2024-01-01', '2024-01-01'),
('Standard Quarterly', '3-month membership with equipment booking and AI features', 214.99, 90, 150, '["Equipment Booking", "AI Coach", "AI Workout Generator", "Progress Tracking", "AI Nutrition Plan"]', 5, true, true, '2024-01-01', '2024-01-01'),
('Premium Quarterly', '3-month premium with equipment, AI, and personal coach', 349.99, 90, 300, '["Equipment Booking", "AI Coach", "AI Workout Generator", "Coach Booking", "Coach Plan Review", "Priority Booking", "AI Nutrition Plan"]', 10, true, true, '2024-01-01', '2024-01-01'),
...
('Standard Annual', 'Full year membership with equipment booking and AI features', 799.99, 365, 600, '["Equipment Booking", "AI Coach", "AI Workout Generator", "Progress Tracking", "Free Guest Pass", "AI Nutrition Plan"]', 5, true, true, '2024-01-01', '2024-01-01'),
('Premium Annual', 'Full year premium - equipment, AI, personal coach, all benefits', 1299.99, 365, 1200, '["Equipment Booking", "AI Coach", "AI Workout Generator", "Coach Booking", "Coach Plan Review", "Priority Booking", "Free Guest Pass", "AI Nutrition Plan"]', 10, true, true, '2024-01-01', '2024-01-01'),
