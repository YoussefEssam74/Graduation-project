...
(2, 'Bench Press Station', 'BP-300', 'IronMaster', 'BP-001', 'Strength Zone B', 0, 5, '2024-10-10', '2025-01-10', 7, 90, NULL, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(1, 'Weight Loss Transformation', '8-week fat loss program', 'Custom', 'Intermediate', 8, '5 days per week', 2, 'Active', 'Approved - great plan', 2, '2024-10-30', 0, true, '2024-11-01', '2024-12-26', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 'Muscle Building Program', '12-week hypertrophy training', 'Custom', 'Advanced', 12, '6 days per week', 4, 'Active', 'Excellent plan', 4, '2024-10-13', 20, true, '2024-10-15', '2025-01-07', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(1, 'Weight Loss Nutrition', 'Calorie deficit plan', 'Custom', 1800, 150, 180, 50, 4, 'Active', 'Well balanced plan', 4, '2024-10-30', 0, true, '2024-11-01', '2024-12-31', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 'Muscle Gain Diet', 'Calorie surplus for bulking', 'Custom', 2800, 200, 350, 80, 4, 'Active', 'Great for bulking', 4, '2024-10-13', 25, true, '2024-10-15', '2025-01-07', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
