...
VALUES
(1, 1, 'Squat', 10, 0.85, 'Good depth and knee alignment. Keep chest up throughout the movement.', 0.15, '{"keypoints": [{"x": 120, "y": 340}, {"x": 125, "y": 380}]}', '2025-01-15 10:00:00', 1),
(2, 1, 'Bench Press', 8, 0.78, 'Elbow flare is slightly wide. Tuck elbows to 45 degrees for safer pressing.', 0.35, '{"keypoints": [{"x": 200, "y": 250}, {"x": 210, "y": 270}]}', '2025-02-10 11:00:00', 1),
(3, 1, 'Deadlift', 5, 0.92, 'Excellent form! Back remains neutral, hips hinge properly. Keep this up.', 0.08, '{"keypoints": [{"x": 150, "y": 400}, {"x": 155, "y": 420}]}', '2025-03-05 12:00:00', 1),
(4, 1, 'Overhead Press', 10, 0.70, 'Bar path deviates forward. Press straight up and slightly back to maintain balance.', 0.40, '{"keypoints": [{"x": 180, "y": 200}, {"x": 185, "y": 180}]}', '2025-04-12 17:00:00', 1),
(5, 1, 'Barbell Row', 10, 0.88, 'Strong pull with good back engagement. Minimize momentum by controlling the eccentric.', 0.12, '{"keypoints": [{"x": 160, "y": 320}, {"x": 165, "y": 300}]}', '2025-05-08 10:30:00', 1),
(6, 1, 'Pull-Up', 8, 0.82, 'Full range of motion achieved. Try to minimize leg swing for stricter form.', 0.18, '{"keypoints": [{"x": 140, "y": 280}, {"x": 145, "y": 260}]}', '2025-06-20 09:00:00', 1),
(7, 1, 'Leg Press', 12, 0.75, 'Knees track inward slightly. Focus on pushing knees outward to protect joints.', 0.30, '{"keypoints": [{"x": 190, "y": 360}, {"x": 195, "y": 380}]}', '2025-07-15 14:00:00', 1),
(8, 1, 'Dumbbell Curl', 12, 0.90, 'Great isolation and control. Maintain this tempo for muscle growth.', 0.10, '{"keypoints": [{"x": 130, "y": 290}, {"x": 135, "y": 310}]}', '2025-08-22 09:30:00', 1),
(9, 1, 'Plank', 1, 0.86, 'Core engaged well. Avoid sagging hips by squeezing glutes throughout.', 0.14, '{"keypoints": [{"x": 170, "y": 330}, {"x": 175, "y": 340}]}', '2025-09-10 16:00:00', 1),
(10, 1, 'Lunges', 10, 0.80, 'Good stride length. Ensure front knee stays behind toes to prevent strain.', 0.20, '{"keypoints": [{"x": 145, "y": 350}, {"x": 150, "y": 370}]}', '2025-10-05 12:30:00', 1);
