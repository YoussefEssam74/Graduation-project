...
-- ==========================================
-- NOTE: Uses new schema with Users table having Role column and separate member_profiles/coach_profiles tables
-- ==========================================
...
(2, 2, '2024-11-16 09:00:00+00', 60, 420, 'Barbell Squat, Deadlift', 'New PR on squats! Heavy deadlift day', 5, true, NOW()),
(1, 1, '2024-11-17 08:00:00+00', 50, 330, 'Barbell Squat, Bench Press, Plank', 'Consistent progress', 4, true, NOW()),
(2, 2, '2024-11-18 09:00:00+00', 65, 450, 'Pull-ups, Deadlift, Bench Press', 'Great session, feeling pumped', 5, true, NOW());
...
(1, 'Lunch', 'Chicken & Rice Bowl', 450, 45, 50, 12, '12:00:00'::interval, 2, NOW()),
(1, 'Dinner', 'Salmon Dinner', 520, 40, 35, 28, '18:00:00'::interval, 2, NOW()),
(2, 'Breakfast', 'Bulking Breakfast', 720, 50, 85, 22, '08:00:00'::interval, 2, NOW());
...
(1, '2024-11-01 10:00:00+00', 85.5, 22.3, 63.2, 58.5, 8, 1850, 10, 'Initial assessment', NOW()),
(1, '2024-11-15 10:00:00+00', 83.8, 20.9, 64.1, 59.2, 7, 1870, 10, 'Good progress', NOW()),
(2, '2024-10-15 11:00:00+00', 78.5, 12.5, 66.8, 62.1, 4, 2020, 10, 'Baseline measurement', NOW()),
(2, '2024-11-15 11:00:00+00', 81.2, 12.8, 69.5, 62.8, 4, 2105, 10, 'Gaining muscle mass', NOW());
...
(2, 129.99, 'USD', 'CreditCard', 'Subscription', 1, 'TXN-1002', NULL, '{"status": "success", "authCode": "DEF456"}', NOW(), NOW()),
...
(2, 3, '2024-10-15', '2024-11-15', 0, true, false, 2, NOW(), NOW()),
(3, 1, '2024-11-10', '2024-12-10', 0, false, false, 3, NOW(), NOW()),
(4, 2, '2024-10-20', '2024-11-20', 0, true, false, 4, NOW(), NOW());
...
(2, 100, 0, 'Subscription plan tokens', 'Subscription', 2, 0, 100, NOW()),
(2, -15, 1, 'Coach session booking', 'Booking', 2, 100, 85, NOW()),
(3, 20, 0, 'Subscription plan tokens', 'Subscription', 3, 0, 20, NOW()),
(3, -6, 1, 'Equipment booking', 'Booking', 3, 20, 14, NOW()),
...
(1, 1, 2, 5, 'Sarah is an amazing coach! Very knowledgeable and supportive.', false, NOW(), NOW()),
(1, 2, 2, 5, 'Great training session, learned proper squat form.', false, NOW(), NOW()),
...
(2, 0, 'normal', 'Coach Session Confirmed', 'Your training session with Sarah Johnson is confirmed', 'Booking', 2, true, '2024-11-27 15:30:00+00', NOW(), NOW()),
...
(2, 'WorkoutCompleted', 'Workout Completed', 'Completed workout: Muscle Building Program - Day 1', 'Workout', 3, '2024-11-16 10:00:00+00'),
(1, 'MilestoneAchieved', 'Milestone Achieved', 'Achieved milestone: First Workout', 'Milestone', 1, '2024-11-15 09:00:00+00'),
(2, 'ReviewPosted', 'Review Posted', 'Posted review for coach Sarah Johnson', 'Review', 2, '2024-11-17 11:00:00+00');
...
(2, 1, 1, true, '2024-10-16 10:00:00+00', NOW()),
(2, 2, 7, true, '2024-10-23 10:00:00+00', NOW()),
(2, 3, 30, true, '2024-11-15 10:00:00+00', NOW());
...
(2, gen_random_uuid(), 'user', 'What exercises should I do for muscle building?', 0, 'gpt-4', '2024-10-10 16:30:00+00'),
(2, gen_random_uuid(), 'assistant', 'For muscle building, focus on compound exercises like squats, deadlifts, bench press, and pull-ups. I recommend training 4-6 days per week.', 20, 'gpt-4', '2024-10-10 16:30:20+00');
...
(2, 'NutritionPlanGeneration', 'Completed', '{"goal": "muscle_gain", "daily_calories": 2800, "protein_grams": 200}', '{"plan_id": 2, "meals_count": 5}', '2024-10-12 14:03:00+00', NOW());
...
(2, 'Nutrition', 'Create a muscle building nutrition plan with 2800 calories', '{"plan": "Muscle Gain Diet", "details": "High protein, moderate carbs, healthy fats distribution"}', 25, NULL, 2, NOW());
...
(7, 'Create', 'WorkoutPlan', 1, '{"member_id": 1, "plan_name": "Weight Loss Transformation"}', '192.168.1.105', 'Mozilla/5.0', '2024-10-28 10:00:00+00'),
(10, 'Create', 'Payment', 1, '{"user_id": 1, "amount": 79.99, "status": "completed"}', '192.168.1.110', 'Mozilla/5.0', '2024-10-31 14:30:00+00');
...
(1, 'Beginner Full Body', 'Perfect starter routine for beginners', 'Beginner', 4, 3, true, true, NOW(), NOW()),
(2, 'Advanced Powerlifting', 'Focus on main lifts with progressive overload', 'Advanced', 12, 5, true, true, NOW(), NOW()),
(3, 'CrossFit WOD', 'High intensity workout of the day', 'Intermediate', 8, 5, true, true, NOW(), NOW());
