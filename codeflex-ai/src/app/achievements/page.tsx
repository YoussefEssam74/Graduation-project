...
function AchievementsContent() {
  ...
  return (
    <div className="min-h-[calc(100vh-6rem)] bg-slate-50 relative p-4 lg:p-8">
      {/* Background */}
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        <div
          className="absolute inset-0 bg-cover bg-center bg-no-repeat blur-lg opacity-10 transform scale-105"
          style={{
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-black text-slate-900 mb-2">Your Achievements</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-100">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <p className="text-2xl font-black text-slate-900">{completedMilestones.length}</p>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-100">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <p className="text-2xl font-black text-slate-900">{inProgressMilestones.length}</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {completedMilestones.map((milestone) => (
                    <div
                      ...
                      className="bg-white rounded-xl p-5 shadow-sm border border-green-100 relative overflow-hidden"
                    >
