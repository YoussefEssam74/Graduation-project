...
namespace Presistence.Migrations
{
    ...
    [Migration("20260605133134_AddRelationalAllergiesAndMasterEdits")]
    partial class AddRelationalAllergiesAndMasterEdits
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntelliFit.Domain.Models.Allergy", b =>
                {
            ...
            modelBuilder.Entity("IntelliFit.Domain.Models.DiseaseAvoidedIngredient", b =>
                {
                    b.Property<int>("DiseaseRuleId")
                        .HasColumnType("integer")
                        .HasColumnName("disease_rule_id");

                    b.Property<int>("IngredientId")
                        .HasColumnType("integer")
                        .HasColumnName("ingredient_id");

                    b.HasKey("DiseaseRuleId", "IngredientId");

                    b.HasIndex("IngredientId");

                    b.ToTable("disease_avoided_ingredients", (string)null);
                });

            modelBuilder.Entity("IntelliFit.Domain.Models.DiseaseRecommendedIngredient", b =>
                {
                    b.Property<int>("DiseaseRuleId")
                        .HasColumnType("integer")
                        .HasColumnName("disease_rule_id");
                    ...
                    b.ToTable("disease_recommended_ingredients", (string)null);
                });

            modelBuilder.Entity("IntelliFit.Domain.Models.DiseaseRule", b =>
                {
                    b.Property<int>("DiseaseRuleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("DiseaseRuleId"));

                    b.Property<int?>("CalorieSampleSize")
                        .HasColumnType("integer")
                        .HasColumnName("calorie_sample_size");

                    b.Property<string>("CalorieSource")
                        .HasColumnType("text")
                        .HasColumnName("calorie_source");

                    b.Property<decimal?>("CarbsGAvg")
                        .HasPrecision(6, 2)
                        .HasColumnType("numeric(6,2)")
                        .HasColumnName("carbs_g_avg");

                    b.Property<decimal?>("CarbsPct")
                        .HasPrecision(5, 2)
                        .HasColumnType("numeric(5,2)")
                        .HasColumnName("carbs_pct");
                    ...
                    b.Property<decimal?>("FatGAvg")
                        .HasPrecision(6, 2)
                        .HasColumnType("numeric(6,2)")
                        .HasColumnName("fat_g_avg");

                    b.Property<decimal?>("FatPct")
                        .HasPrecision(5, 2)
                        .HasColumnType("numeric(5,2)")
                        .HasColumnName("fat_pct");

                    b.Property<string>("MacroSource")
                        .HasColumnType("text")
                        .HasColumnName("macro_source");

                    b.Property<int?>("MaxKcal")
                        .HasColumnType("integer")
                        .HasColumnName("max_kcal");

                    b.Property<int?>("MedianKcal")
                        .HasColumnType("integer")
                        .HasColumnName("median_kcal");

                    b.Property<int?>("MinKcal")
                        .HasColumnType("integer")
                        .HasColumnName("min_kcal");

                    b.Property<decimal?>("ProteinGAvg")
                        .HasPrecision(6, 2)
                        .HasColumnType("numeric(6,2)")
                        .HasColumnName("protein_g_avg");

                    b.Property<decimal?>("ProteinPct")
                        .HasPrecision(5, 2)
                        .HasColumnType("numeric(5,2)")
                        .HasColumnName("protein_pct");

                    b.HasKey("DiseaseRuleId");

                    b.HasIndex("DiseaseKey")
                        .IsUnique();

                    b.ToTable("disease_rules", (string)null);
                });
            ...
            modelBuilder.Entity("IntelliFit.Domain.Models.IngredientAllergy", b =>
                {
                    b.Property<int>("IngredientId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ingredient_allergies", (string)null);
                });
            ...
            modelBuilder.Entity("IntelliFit.Domain.Models.MemberAllergy", b =>
                {
                    ...
                    b.HasKey("MemberProfileId", "AllergyId");

                    b.HasIndex("AllergyId");

                    b.ToTable("member_allergies", (string)null);
                });
            ...
            modelBuilder.Entity("IntelliFit.Domain.Models.SubscriptionPlan", b =>
                {
                    ...
                    b.Property<int>("ExtraNutritionPlanTokenCost")
                        .HasColumnType("integer");

                    b.Property<int>("ExtraWorkoutPlanTokenCost")
                        .HasColumnType("integer");

                    b.Property<string>("Features")
                        .HasColumnType("text");

                    b.Property<int>("FreeAiCoachMessagesPerDay")
                        .HasColumnType("integer");

                    b.Property<int>("FreeNutritionPlans")
                        .HasColumnType("integer");

                    b.Property<int>("FreeWorkoutPlans")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("IntelliFit.Domain.Models.DiseaseAvoidedIngredient", b =>
                {
                    b.HasOne("IntelliFit.Domain.Models.DiseaseRule", "DiseaseRule")
                        .WithMany("AvoidedIngredients")
                        .HasForeignKey("DiseaseRuleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IntelliFit.Domain.Models.DiseaseRecommendedIngredient", b =>
                {
                    b.HasOne("IntelliFit.Domain.Models.DiseaseRule", "DiseaseRule")
                        .WithMany("RecommendedIngredients")
                        .HasForeignKey("DiseaseRuleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IntelliFit.Domain.Models.IngredientAllergy", b =>
                {
                    b.HasOne("IntelliFit.Domain.Models.Allergy", "Allergy")
            ...
            modelBuilder.Entity("IntelliFit.Domain.Models.MemberAllergy", b =>
                {
                    b.HasOne("IntelliFit.Domain.Models.Allergy", "Allergy")
                        .WithMany("MemberAllergies")
                        .HasForeignKey("AllergyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IntelliFit.Domain.Models.MemberProfile", "MemberProfile")
                        .WithMany("MemberAllergies")
            ...
            modelBuilder.Entity("IntelliFit.Domain.Models.DiseaseRule", b =>
                {
                    ...
                    b.Navigation("RecommendedIngredients");
                });
