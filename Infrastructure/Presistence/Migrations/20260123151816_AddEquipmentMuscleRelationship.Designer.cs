...
namespace Presistence.Migrations
{
    ...
    [Migration("20260123151816_AddEquipmentMuscleRelationship")]
    partial class AddEquipmentMuscleRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntelliFit.Domain.Models.Equipment", b =>
                {
                    ...
                    b.Property<int?>("WgerEquipmentId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("IntelliFit.Domain.Models.EquipmentMuscle", b =>
                {
                    b.Property<int>("EquipmentMuscleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("equipment_muscle_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("EquipmentMuscleId"));
                    ...
                    b.HasKey("EquipmentMuscleId");

                    b.HasIndex("EquipmentId");

                    b.HasIndex("MuscleId");

                    b.ToTable("equipment_muscles", (string)null);
                });
            ...
            modelBuilder.Entity("IntelliFit.Domain.Models.ExerciseCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("IntelliFit.Domain.Models.ExerciseEquipment", b =>
                {
                    b.Property<int>("ExerciseId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("exercise_equipments", (string)null);
                });

            modelBuilder.Entity("IntelliFit.Domain.Models.ExerciseMuscle", b =>
                {
                    b.Property<int>("ExerciseId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("IntelliFit.Domain.Models.Muscle", b =>
                {
                    b.Property<int>("MuscleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("MuscleId"));
            ...
            modelBuilder.Entity("IntelliFit.Domain.Models.EquipmentMuscle", b =>
                {
                    b.HasOne("IntelliFit.Domain.Models.Equipment", "Equipment")
                        .WithMany("EquipmentMuscles")
                        .HasForeignKey("EquipmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IntelliFit.Domain.Models.Muscle", "Muscle")
                        .WithMany()
            ...
            modelBuilder.Entity("IntelliFit.Domain.Models.Exercise", b =>
                {
                    ...
                    b.HasOne("IntelliFit.Domain.Models.ExerciseCategory", "ExerciseCategory")
                        .WithMany("Exercises")
